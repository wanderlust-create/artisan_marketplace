  ...
  test 'should create invoice_item' do
    assert_difference('InvoiceItem.count') do
      post invoice_items_url,
           params: { invoice_item: { invoice_id: @invoice_item.invoice_id, product_id: @invoice_item.product_id,
                                     quantity: @invoice_item.quantity, unit_price: @invoice_item.unit_price } }
    end
